        ...
        <form class="col-xs-4" role="search" method="POST" action="/inventory" >
            <div class="input-group">
                ...
                <div class="input-group-btn">
                    <button class="btn btn-default secondary-color secondary-border-color secondary-hover" type="submit"><span class="glyphicon glyphicon-search secondary-color"></span></button>
                </div>
            </div>
        </form>
